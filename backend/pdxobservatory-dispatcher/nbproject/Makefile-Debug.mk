...
${OBJECTDIR}/dbconn.o: dbconn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbconn.o dbconn.cpp

${OBJECTDIR}/guides/cnc_context/temperature.o: guides/cnc_context/temperature.cpp 
	${MKDIR} -p ${OBJECTDIR}/guides/cnc_context
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guides/cnc_context/temperature.o guides/cnc_context/temperature.cpp

${OBJECTDIR}/guides/guide.o: guides/guide.cpp 
	${MKDIR} -p ${OBJECTDIR}/guides
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guides/guide.o guides/guide.cpp

${OBJECTDIR}/guides/guide_mobility.o: guides/guide_mobility.cpp 
	${MKDIR} -p ${OBJECTDIR}/guides
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guides/guide_mobility.o guides/guide_mobility.cpp

${OBJECTDIR}/guides/guide_mobility_extended.o: guides/guide_mobility_extended.cpp 
	${MKDIR} -p ${OBJECTDIR}/guides
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guides/guide_mobility_extended.o guides/guide_mobility_extended.cpp

${OBJECTDIR}/guides/guide_temperature.o: guides/guide_temperature.cpp 
	${MKDIR} -p ${OBJECTDIR}/guides
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guides/guide_temperature.o guides/guide_temperature.cpp

${OBJECTDIR}/guides/types.o: guides/types.cpp 
	${MKDIR} -p ${OBJECTDIR}/guides
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guides/types.o guides/types.cpp

${OBJECTDIR}/pdxobservatory.o: pdxobservatory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pdxobservatory.o pdxobservatory.cpp

${OBJECTDIR}/socketconnhandler.o: socketconnhandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socketconnhandler.o socketconnhandler.cpp

${OBJECTDIR}/threadlib.o: threadlib.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/threadlib.o threadlib.cpp
